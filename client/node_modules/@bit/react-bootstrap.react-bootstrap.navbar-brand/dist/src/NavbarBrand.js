...
function (_React$Component) {
  ...
  function NavbarBrand() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(NavbarBrand).apply(this, arguments));
  }
  ...
  _createClass(NavbarBrand, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          as = _this$props.as,
          props = _objectWithoutProperties(_this$props, ["bsPrefix", "className", "as"]);
...
_defineProperty(NavbarBrand, "propTypes", {
  /** @default 'navbar' */
