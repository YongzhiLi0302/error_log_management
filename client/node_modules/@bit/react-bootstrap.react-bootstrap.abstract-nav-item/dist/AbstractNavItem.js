...
function (_React$Component) {
  _inherits(AbstractNavItem, _React$Component);

  function AbstractNavItem() {
    _classCallCheck(this, AbstractNavItem);

    return _possibleConstructorReturn(this, _getPrototypeOf(AbstractNavItem).apply(this, arguments));
  }

  _createClass(AbstractNavItem, [{
    key: "render",
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          props = _objectWithoutProperties(_this$props, ["active", "className", "tabIndex", "eventKey", "onSelect", "as"]);
